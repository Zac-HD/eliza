...
PATTERNS = [
    ...
    [
        "I think (.*)",
        ["Do you doubt {}?", "Do you really think so?", "But you're not sure {}?"],
    ],
    [
        "(.*) friend (.*)",
        [
    ...
    ["Why (.*)", ["Why don't you tell me the reason why {}?", "Why do you think {}?"]],
    [
        "I want (.*)",
        [
...
def respond(str_):
    ...
    for pattern, responses in PATTERNS:
        ...
        if match is not None:
            ...
            return resp.format(translate(part))
